...
<div class="head-content px-3 pt-0 bg-light">
    <div class="row w-100 justify-content-between align-items-center  py-3">
        <div class="col-lg-12">
            <div class="category-title my-0 py-0"><input type="text" class=" w-100 form-control" v-model="searchData" placeholder="البحث..."></div>
        </div>
