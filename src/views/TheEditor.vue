<template>
            ...
            <div class="item-news">
                <router-link :to="'/news-dt/'+news.uuid" href="#">
                    <div class="news-slide small-slid">
                        ...
                        <img v-else src="https://newsapp.be875981ca9416725.temporary.link/images/Splash.jpg" alt="">
  ...
  <ul class="pagination">
    ...
    <li class="page-item" v-for="i in pageNumber" :index="i" :key="i"><a class="page-link" @click="getEditorData(i)" href="#">{{i}}</a></li>
    <li class="page-item">
...
export default 
{
  ...
  methods:{
    getEditorData(id){
        ...
        axios.get(`editor_picks_news?page=${this.pageNumber}`)
        .then(res => {
