    ...
    <div class="row justify-content-between align-items-center  py-3 w-100">
        <div class="col-auto">
            <ul class="nav nav-pills">
                <li class="nav-item">
                  <a class="nav-link active" aria-current="page" href="#">اخبار اليوم</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#">الأكثر قراءة</a>
                </li>
              </ul>
        </div>
        <div class="col-auto">
            <ul class="list-feltar">
                <li><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="10.645" height="10.938" viewBox="0 0 10.645 10.938">
                ...
                <li><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="11.875" viewBox="0 0 15 11.875">
                ...
                <li><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="13.51" height="13.51" viewBox="0 0 13.51 13.51">
                ...
                <li><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="13.333" height="18.333" viewBox="0 0 13.333 18.333">
...
<div class="loop-news px-4 pb-4">
    <div class="category-title">تكنولوجيا المعلومات</div>
    <div class="row g-4">
