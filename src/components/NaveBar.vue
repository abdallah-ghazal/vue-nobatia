<template>
    ...
    <ul class="list-right-center">
        <li><router-link to="/catogores"><svg xmlns="http://www.w3.org/2000/svg" width="13.667" height="13.667" viewBox="0 0 13.667 13.667">
        ...
        <li><router-link to="/favorits" ><svg xmlns="http://www.w3.org/2000/svg" width="16.667" height="15.833" viewBox="0 0 16.667 15.833">
        ...
        <li><router-link to="/login" ><svg xmlns="http://www.w3.org/2000/svg" width="18.333" height="18.333" viewBox="0 0 18.333 18.333">
...
<div class="main-list-after-right">
    <ul class="list-main">
        <li>
            <router-link to="/">
        ...
        <li>
            <router-link to="/catogores" href="#">
                <span class="icon"><img src="@/assets/ex.png" alt="">
                  </span>
                <span class="text">تكنولوجيا المعلومات</span>
            </router-link >
            <ul class="drop-down">
                <li><router-link to="/catogory">عالم الحاسوب</router-link></li>
                <li><a href="#">تكنولوجيا الويب</a></li>
                <li><a href="#">الموبايلات</a></li>
            </ul>
        </li>
        <li>
            <a href="#">
        ...
        <li>
            <a href="#">
                ...
                <span class="text">اخبار سياسية</span>
            </a>
            <ul class="drop-down">
                <li><a href="#">الجزيرة</a></li>
        ...
        <li>
            <a href="#">
                ...
                <span class="text">اخبار اسرية</span>
            </a>
            <ul class="drop-down">
                <li><a href="#">صحة الطفل</a></li>
            </ul>
        </li>
    </ul>
</div>
